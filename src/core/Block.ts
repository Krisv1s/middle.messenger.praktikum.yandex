...
type EventTypes = Record<string, (e: Event) => void>;
...
export default abstract class Block {
  ...
  public compile(template: (context: any) => string, props?: Record<string, unknown>) {
    ...
    const compileHTML = template(propsAndStubs);
